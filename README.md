<div class="docs-hero">
  <h1>SoundCloud</h1>
  <p class="docs-hero-lead">Modern .NET SDK for SoundCloud generated from the provider's OpenAPI definition with AutoSDK.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/SoundCloud/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/SoundCloud"></a>
    <a href="https://github.com/tryAGI/SoundCloud/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/SoundCloud/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/SoundCloud/blob/main/LICENSE"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/SoundCloud"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from <a href="https://raw.githubusercontent.com/soundcloud/api/master/openapi/api.yaml">SoundCloud's OpenAPI definition</a> so the SDK stays close to the upstream API surface.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
using var client = new SoundCloudClient(accessToken);
```

Pass the raw OAuth access token; the SDK emits the required `Authorization: OAuth` header.
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/SoundCloud/issues">tryAGI/SoundCloud</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/SoundCloud/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
