...
namespace SoundCloud
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_UpdatesAPlaylistSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_UpdatesAPlaylistSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_UpdatesAPlaylistSecurityRequirement0,
            };
        partial void PrepareUpdatesAPlaylistArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistUrn,
            global::SoundCloud.CreateUpdatePlaylistRequest request);
        partial void PrepareUpdatesAPlaylistRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string playlistUrn,
            global::SoundCloud.CreateUpdatePlaylistRequest request);
        partial void ProcessUpdatesAPlaylistResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdatesAPlaylistResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Playlist> UpdatesAPlaylistAsync(
            string playlistUrn,
        ...
        {
            var __response = await UpdatesAPlaylistAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Playlist>> UpdatesAPlaylistAsResponseAsync(
            string playlistUrn,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdatesAPlaylistArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdatesAPlaylistSecurityRequirements,
                operationName: "UpdatesAPlaylistAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdatesAPlaylistRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdatesAPlaylist",
                                methodName: "UpdatesAPlaylistAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdatesAPlaylistResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdatesAPlaylistResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpdatesAPlaylistAsync(
                playlistUrn: playlistUrn,
                request: __request,
                requestOptions: requestOptions,
