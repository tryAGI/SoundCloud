...
namespace SoundCloud
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsACollectionOfPlaylistsRepostersSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsACollectionOfPlaylistsRepostersSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsACollectionOfPlaylistsRepostersSecurityRequirement0,
            };
        partial void PrepareReturnsACollectionOfPlaylistsRepostersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistUrn,
            ref int? limit);
        partial void PrepareReturnsACollectionOfPlaylistsRepostersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string playlistUrn,
            int? limit);
        partial void ProcessReturnsACollectionOfPlaylistsRepostersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsACollectionOfPlaylistsRepostersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Users> ReturnsACollectionOfPlaylistsRepostersAsync(
            string playlistUrn,
            int? limit = default,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ReturnsACollectionOfPlaylistsRepostersAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Users>> ReturnsACollectionOfPlaylistsRepostersAsResponseAsync(
            string playlistUrn,
            int? limit = default,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsACollectionOfPlaylistsRepostersArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsACollectionOfPlaylistsRepostersSecurityRequirements,
                operationName: "ReturnsACollectionOfPlaylistsRepostersAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsACollectionOfPlaylistsRepostersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsACollectionOfPlaylistsReposters",
                                methodName: "ReturnsACollectionOfPlaylistsRepostersAsync",
                                pathTemplate: "$\"/playlists/{playlistUrn}/reposters\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsACollectionOfPlaylistsRepostersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsACollectionOfPlaylistsRepostersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
