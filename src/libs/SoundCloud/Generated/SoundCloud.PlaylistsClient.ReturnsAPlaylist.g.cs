...
namespace SoundCloud
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsAPlaylistSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsAPlaylistSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsAPlaylistSecurityRequirement0,
            };
        partial void PrepareReturnsAPlaylistArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistUrn,
            ref string? secretToken,
            global::System.Collections.Generic.IList<global::SoundCloud.GetPlaylistsAcces2>? access,
            ref bool? showTracks);
        partial void PrepareReturnsAPlaylistRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<global::SoundCloud.GetPlaylistsAcces2>? access,
            bool? showTracks);
        partial void ProcessReturnsAPlaylistResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsAPlaylistResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Playlist> ReturnsAPlaylistAsync(
            string playlistUrn,
        ...
        {
            var __response = await ReturnsAPlaylistAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Playlist>> ReturnsAPlaylistAsResponseAsync(
            string playlistUrn,
            string? secretToken = default,
            global::System.Collections.Generic.IList<global::SoundCloud.GetPlaylistsAcces2>? access = default,
            bool? showTracks = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsAPlaylistArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsAPlaylistSecurityRequirements,
                operationName: "ReturnsAPlaylistAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsAPlaylistRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsAPlaylist",
                                methodName: "ReturnsAPlaylistAsync",
                                pathTemplate: "$\"/playlists/{playlistUrn}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsAPlaylistResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsAPlaylistResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SoundCloud.Playlist.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Playlist>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SoundCloud.Playlist.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
