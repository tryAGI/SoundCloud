...
{
    /// <inheritdoc />
    public sealed class TrackDataRequestTrackEmbeddableByJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::SoundCloud.TrackDataRequestTrackEmbeddableBy>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::SoundCloud.TrackDataRequestTrackEmbeddableByExtensions.ToValueString(value));
        }
    }
}
