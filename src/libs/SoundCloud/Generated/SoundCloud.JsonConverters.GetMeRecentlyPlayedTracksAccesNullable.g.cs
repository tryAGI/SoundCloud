...
{
    /// <inheritdoc />
    public sealed class GetMeRecentlyPlayedTracksAccesNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::SoundCloud.GetMeRecentlyPlayedTracksAcces?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::SoundCloud.GetMeRecentlyPlayedTracksAccesExtensions.ToValueString(value.Value));
            }
        }
    }
}
