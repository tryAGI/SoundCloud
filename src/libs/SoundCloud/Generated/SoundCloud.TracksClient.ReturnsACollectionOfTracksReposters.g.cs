...
namespace SoundCloud
{
    public partial class TracksClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsACollectionOfTracksRepostersSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsACollectionOfTracksRepostersSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsACollectionOfTracksRepostersSecurityRequirement0,
            };
        partial void PrepareReturnsACollectionOfTracksRepostersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string trackUrn,
            ref int? limit);
        partial void PrepareReturnsACollectionOfTracksRepostersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string trackUrn,
            int? limit);
        partial void ProcessReturnsACollectionOfTracksRepostersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsACollectionOfTracksRepostersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Users> ReturnsACollectionOfTracksRepostersAsync(
            string trackUrn,
            int? limit = default,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ReturnsACollectionOfTracksRepostersAsResponseAsync(
                trackUrn: trackUrn,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Users>> ReturnsACollectionOfTracksRepostersAsResponseAsync(
            string trackUrn,
            int? limit = default,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsACollectionOfTracksRepostersArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsACollectionOfTracksRepostersSecurityRequirements,
                operationName: "ReturnsACollectionOfTracksRepostersAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsACollectionOfTracksRepostersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsACollectionOfTracksReposters",
                                methodName: "ReturnsACollectionOfTracksRepostersAsync",
                                pathTemplate: "$\"/tracks/{trackUrn}/reposters\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsACollectionOfTracksRepostersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsACollectionOfTracksRepostersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
