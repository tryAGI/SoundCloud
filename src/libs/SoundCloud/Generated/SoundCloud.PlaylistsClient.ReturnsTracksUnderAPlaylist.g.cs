...
namespace SoundCloud
{
    public partial class PlaylistsClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsTracksUnderAPlaylistSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsTracksUnderAPlaylistSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsTracksUnderAPlaylistSecurityRequirement0,
            };
        partial void PrepareReturnsTracksUnderAPlaylistArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string playlistUrn,
            ref string? secretToken,
            global::System.Collections.Generic.IList<global::SoundCloud.GetPlaylistsTracksAcces>? access,
            ref bool? linkedPartitioning);
        partial void PrepareReturnsTracksUnderAPlaylistRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessReturnsTracksUnderAPlaylistResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsTracksUnderAPlaylistResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.OneOf<global::SoundCloud.Tracks, global::System.Collections.Generic.IList<global::SoundCloud.Track>>> ReturnsTracksUnderAPlaylistAsync(
            string playlistUrn,
        ...
        {
            var __response = await ReturnsTracksUnderAPlaylistAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.OneOf<global::SoundCloud.Tracks, global::System.Collections.Generic.IList<global::SoundCloud.Track>>>> ReturnsTracksUnderAPlaylistAsResponseAsync(
            string playlistUrn,
            string? secretToken = default,
            global::System.Collections.Generic.IList<global::SoundCloud.GetPlaylistsTracksAcces>? access = default,
            bool? linkedPartitioning = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsTracksUnderAPlaylistArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsTracksUnderAPlaylistSecurityRequirements,
                operationName: "ReturnsTracksUnderAPlaylistAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsTracksUnderAPlaylistRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsTracksUnderAPlaylist",
                                methodName: "ReturnsTracksUnderAPlaylistAsync",
                                pathTemplate: "$\"/playlists/{playlistUrn}/tracks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsTracksUnderAPlaylistResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsTracksUnderAPlaylistResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
