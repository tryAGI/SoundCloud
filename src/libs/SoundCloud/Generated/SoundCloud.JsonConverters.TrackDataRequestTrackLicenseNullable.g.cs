...
{
    /// <inheritdoc />
    public sealed class TrackDataRequestTrackLicenseNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::SoundCloud.TrackDataRequestTrackLicense?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::SoundCloud.TrackDataRequestTrackLicenseExtensions.ToValueString(value.Value));
            }
        }
    }
}
