...
namespace SoundCloud
{
    public partial class MiscellaneousClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiSecurityRequirement0,
            };
        partial void PrepareResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string url);
        partial void PrepareResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string url);
        partial void ProcessResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiAsync(
            string url,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiAsResponseAsync(
                url: url,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse> ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiAsResponseAsync(
            string url,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiSecurityRequirements,
                operationName: "ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApi",
                                methodName: "ResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessResolvesSoundcloudComAndOnSoundcloudComURLsToResourceURLsToUseWithTheApiResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 302)
                            {
                                ...
                                global::SoundCloud.Found? __value_302 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_302 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_302 = global::SoundCloud.Found.FromJson(__content_302, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_302 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::SoundCloud.ApiException<global::SoundCloud.Found>.Create(
