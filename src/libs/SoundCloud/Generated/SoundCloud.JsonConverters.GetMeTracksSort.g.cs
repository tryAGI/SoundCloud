...
{
    /// <inheritdoc />
    public sealed class GetMeTracksSortJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::SoundCloud.GetMeTracksSort>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::SoundCloud.GetMeTracksSortExtensions.ToValueString(value));
        }
    }
}
