...
namespace SoundCloud
{
    public partial class UsersClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudSecurityRequirement0,
            };
        partial void PrepareReturnsRelatedArtistRecommendationsForAUserOnSoundCloudArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userUrn,
            ref int? limit,
            ref int? offset,
            ref bool? linkedPartitioning);
        partial void PrepareReturnsRelatedArtistRecommendationsForAUserOnSoundCloudRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessReturnsRelatedArtistRecommendationsForAUserOnSoundCloudResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsRelatedArtistRecommendationsForAUserOnSoundCloudResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Users> ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudAsync(
            string userUrn,
            int? limit = default,
            int? offset = default,
        ...
        {
            var __response = await ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudAsResponseAsync(
                userUrn: userUrn,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Users>> ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudAsResponseAsync(
            string userUrn,
            int? limit = default,
            int? offset = default,
            bool? linkedPartitioning = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsRelatedArtistRecommendationsForAUserOnSoundCloudArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudSecurityRequirements,
                operationName: "ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsRelatedArtistRecommendationsForAUserOnSoundCloudRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsRelatedArtistRecommendationsForAUserOnSoundCloud",
                                methodName: "ReturnsRelatedArtistRecommendationsForAUserOnSoundCloudAsync",
                                pathTemplate: "$\"/users/{userUrn}/related\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsRelatedArtistRecommendationsForAUserOnSoundCloudResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsRelatedArtistRecommendationsForAUserOnSoundCloudResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SoundCloud.Users.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Users>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SoundCloud.Users.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
