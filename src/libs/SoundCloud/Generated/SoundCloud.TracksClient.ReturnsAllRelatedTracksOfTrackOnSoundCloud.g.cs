...
namespace SoundCloud
{
    public partial class TracksClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsAllRelatedTracksOfTrackOnSoundCloudSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsAllRelatedTracksOfTrackOnSoundCloudSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsAllRelatedTracksOfTrackOnSoundCloudSecurityRequirement0,
            };
        partial void PrepareReturnsAllRelatedTracksOfTrackOnSoundCloudArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string trackUrn,
            global::System.Collections.Generic.IList<global::SoundCloud.GetTracksRelatedAcces>? access,
            ref int? limit,
            ref int? offset,
            ref bool? linkedPartitioning);
        partial void PrepareReturnsAllRelatedTracksOfTrackOnSoundCloudRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessReturnsAllRelatedTracksOfTrackOnSoundCloudResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsAllRelatedTracksOfTrackOnSoundCloudResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.OneOf<global::SoundCloud.Tracks, global::System.Collections.Generic.IList<global::SoundCloud.Track>>> ReturnsAllRelatedTracksOfTrackOnSoundCloudAsync(
            string trackUrn,
        ...
        {
            var __response = await ReturnsAllRelatedTracksOfTrackOnSoundCloudAsResponseAsync(
                trackUrn: trackUrn,
                access: access,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.OneOf<global::SoundCloud.Tracks, global::System.Collections.Generic.IList<global::SoundCloud.Track>>>> ReturnsAllRelatedTracksOfTrackOnSoundCloudAsResponseAsync(
            string trackUrn,
            global::System.Collections.Generic.IList<global::SoundCloud.GetTracksRelatedAcces>? access = default,
            int? limit = default,
            int? offset = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsAllRelatedTracksOfTrackOnSoundCloudArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsAllRelatedTracksOfTrackOnSoundCloudSecurityRequirements,
                operationName: "ReturnsAllRelatedTracksOfTrackOnSoundCloudAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsAllRelatedTracksOfTrackOnSoundCloudRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsAllRelatedTracksOfTrackOnSoundCloud",
                                methodName: "ReturnsAllRelatedTracksOfTrackOnSoundCloudAsync",
                                pathTemplate: "$\"/tracks/{trackUrn}/related\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsAllRelatedTracksOfTrackOnSoundCloudResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsAllRelatedTracksOfTrackOnSoundCloudResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
