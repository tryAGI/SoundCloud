...
{
    /// <inheritdoc />
    public sealed class CreateUpdatePlaylistRequestPlaylistSharingJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::SoundCloud.CreateUpdatePlaylistRequestPlaylistSharing>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::SoundCloud.CreateUpdatePlaylistRequestPlaylistSharingExtensions.ToValueString(value));
        }
    }
}
