...
namespace SoundCloud
{
    public partial class UsersClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsAListOfUsersTracksSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsAListOfUsersTracksSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsAListOfUsersTracksSecurityRequirement0,
            };
        partial void PrepareReturnsAListOfUsersTracksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string userUrn,
            global::System.Collections.Generic.IList<global::SoundCloud.GetUsersTracksAcces>? access,
            ref int? limit,
            ref global::SoundCloud.GetUsersTracksSort? sort,
            ref bool? linkedPartitioning);
        partial void PrepareReturnsAListOfUsersTracksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string userUrn,
            global::System.Collections.Generic.IList<global::SoundCloud.GetUsersTracksAcces>? access,
            int? limit,
            global::SoundCloud.GetUsersTracksSort? sort,
            bool? linkedPartitioning);
        partial void ProcessReturnsAListOfUsersTracksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsAListOfUsersTracksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.OneOf<global::SoundCloud.Tracks, global::System.Collections.Generic.IList<global::SoundCloud.Track>>> ReturnsAListOfUsersTracksAsync(
            string userUrn,
            global::System.Collections.Generic.IList<global::SoundCloud.GetUsersTracksAcces>? access = default,
            int? limit = default,
            global::SoundCloud.GetUsersTracksSort? sort = default,
            bool? linkedPartitioning = default,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ReturnsAListOfUsersTracksAsResponseAsync(
                userUrn: userUrn,
                access: access,
                limit: limit,
                sort: sort,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.OneOf<global::SoundCloud.Tracks, global::System.Collections.Generic.IList<global::SoundCloud.Track>>>> ReturnsAListOfUsersTracksAsResponseAsync(
            string userUrn,
            global::System.Collections.Generic.IList<global::SoundCloud.GetUsersTracksAcces>? access = default,
            int? limit = default,
            global::SoundCloud.GetUsersTracksSort? sort = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsAListOfUsersTracksArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsAListOfUsersTracksSecurityRequirements,
                operationName: "ReturnsAListOfUsersTracksAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsAListOfUsersTracksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsAListOfUsersTracks",
                                methodName: "ReturnsAListOfUsersTracksAsync",
                                pathTemplate: "$\"/users/{userUrn}/tracks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsAListOfUsersTracksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsAListOfUsersTracksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
