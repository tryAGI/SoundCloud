...
{
    /// <inheritdoc />
    public sealed class CreateUpdatePlaylistFormRequestPlaylistSharingJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::SoundCloud.CreateUpdatePlaylistFormRequestPlaylistSharing>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::SoundCloud.CreateUpdatePlaylistFormRequestPlaylistSharingExtensions.ToValueString(value));
        }
    }
}
