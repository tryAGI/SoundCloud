...
namespace SoundCloud
{
    public partial class MeClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsTheAuthenticatedUsersInformationSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsTheAuthenticatedUsersInformationSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsTheAuthenticatedUsersInformationSecurityRequirement0,
            };
        partial void PrepareReturnsTheAuthenticatedUsersInformationArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareReturnsTheAuthenticatedUsersInformationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessReturnsTheAuthenticatedUsersInformationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsTheAuthenticatedUsersInformationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Me> ReturnsTheAuthenticatedUsersInformationAsync(
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ReturnsTheAuthenticatedUsersInformationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Me>> ReturnsTheAuthenticatedUsersInformationAsResponseAsync(
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsTheAuthenticatedUsersInformationArguments(
                httpClient: HttpClient);


            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ReturnsTheAuthenticatedUsersInformationSecurityRequirements,
                operationName: "ReturnsTheAuthenticatedUsersInformationAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsTheAuthenticatedUsersInformationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsTheAuthenticatedUsersInformation",
                                methodName: "ReturnsTheAuthenticatedUsersInformationAsync",
                                pathTemplate: "\"/me\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsTheAuthenticatedUsersInformationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsTheAuthenticatedUsersInformationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SoundCloud.Me.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Me>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SoundCloud.Me.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
