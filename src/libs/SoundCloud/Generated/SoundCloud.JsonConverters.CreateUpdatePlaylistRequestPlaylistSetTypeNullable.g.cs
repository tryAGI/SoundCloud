...
{
    /// <inheritdoc />
    public sealed class CreateUpdatePlaylistRequestPlaylistSetTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::SoundCloud.CreateUpdatePlaylistRequestPlaylistSetType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::SoundCloud.CreateUpdatePlaylistRequestPlaylistSetTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
