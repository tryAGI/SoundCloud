...
namespace SoundCloud
{
    public partial class TracksClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_UpdatesATracksInformationSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_UpdatesATracksInformationSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_UpdatesATracksInformationSecurityRequirement0,
            };
        partial void PrepareUpdatesATracksInformationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string trackUrn,
            global::SoundCloud.TrackMetadataRequest request);
        partial void PrepareUpdatesATracksInformationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string trackUrn,
            global::SoundCloud.TrackMetadataRequest request);
        partial void ProcessUpdatesATracksInformationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdatesATracksInformationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Track> UpdatesATracksInformationAsync(
            string trackUrn,
        ...
        {
            var __response = await UpdatesATracksInformationAsResponseAsync(
                trackUrn: trackUrn,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Track>> UpdatesATracksInformationAsResponseAsync(
            string trackUrn,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdatesATracksInformationArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdatesATracksInformationSecurityRequirements,
                operationName: "UpdatesATracksInformationAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdatesATracksInformationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdatesATracksInformation",
                                methodName: "UpdatesATracksInformationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdatesATracksInformationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdatesATracksInformationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Track> UpdatesATracksInformationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::SoundCloud.TrackMetadataRequest
            {
                Track = track,
            };

            return await UpdatesATracksInformationAsync(
                trackUrn: trackUrn,
                request: __request,
                requestOptions: requestOptions,
