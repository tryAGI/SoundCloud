...
namespace SoundCloud
{
    public partial class TracksClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsTheCommentsPostedOnTheTrackTrackUrnSecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsTheCommentsPostedOnTheTrackTrackUrnSecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsTheCommentsPostedOnTheTrackTrackUrnSecurityRequirement0,
            };
        partial void PrepareReturnsTheCommentsPostedOnTheTrackTrackUrnArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string trackUrn,
            ref int? limit,
            ref int? offset,
            ref bool? linkedPartitioning);
        partial void PrepareReturnsTheCommentsPostedOnTheTrackTrackUrnRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessReturnsTheCommentsPostedOnTheTrackTrackUrnResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsTheCommentsPostedOnTheTrackTrackUrnResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Comments> ReturnsTheCommentsPostedOnTheTrackTrackUrnAsync(
            string trackUrn,
            int? limit = default,
            int? offset = default,
        ...
        {
            var __response = await ReturnsTheCommentsPostedOnTheTrackTrackUrnAsResponseAsync(
                trackUrn: trackUrn,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Comments>> ReturnsTheCommentsPostedOnTheTrackTrackUrnAsResponseAsync(
            string trackUrn,
            int? limit = default,
            int? offset = default,
            bool? linkedPartitioning = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsTheCommentsPostedOnTheTrackTrackUrnArguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsTheCommentsPostedOnTheTrackTrackUrnSecurityRequirements,
                operationName: "ReturnsTheCommentsPostedOnTheTrackTrackUrnAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsTheCommentsPostedOnTheTrackTrackUrnRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsTheCommentsPostedOnTheTrackTrackUrn",
                                methodName: "ReturnsTheCommentsPostedOnTheTrackTrackUrnAsync",
                                pathTemplate: "$\"/tracks/{trackUrn}/comments\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsTheCommentsPostedOnTheTrackTrackUrnResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsTheCommentsPostedOnTheTrackTrackUrnResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::SoundCloud.Comments.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Comments>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::SoundCloud.Comments.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
