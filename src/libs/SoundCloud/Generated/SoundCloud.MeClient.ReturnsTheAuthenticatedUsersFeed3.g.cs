...
namespace SoundCloud
{
    public partial class MeClient
    {
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement s_ReturnsTheAuthenticatedUsersFeed3SecurityRequirement0 =
        ...
        private static readonly global::SoundCloud.EndPointSecurityRequirement[] s_ReturnsTheAuthenticatedUsersFeed3SecurityRequirements =
            new global::SoundCloud.EndPointSecurityRequirement[]
            {                s_ReturnsTheAuthenticatedUsersFeed3SecurityRequirement0,
            };
        partial void PrepareReturnsTheAuthenticatedUsersFeed3Arguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::SoundCloud.GetMeFeedAcces>? access,
            ref int? limit);
        partial void PrepareReturnsTheAuthenticatedUsersFeed3Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::SoundCloud.GetMeFeedAcces>? access,
            int? limit);
        partial void ProcessReturnsTheAuthenticatedUsersFeed3Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReturnsTheAuthenticatedUsersFeed3ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::SoundCloud.Activities> ReturnsTheAuthenticatedUsersFeed3Async(
        ...
        {
            var __response = await ReturnsTheAuthenticatedUsersFeed3AsResponseAsync(
                access: access,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::SoundCloud.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::SoundCloud.AutoSDKHttpResponse<global::SoundCloud.Activities>> ReturnsTheAuthenticatedUsersFeed3AsResponseAsync(
            global::System.Collections.Generic.IList<global::SoundCloud.GetMeFeedAcces>? access = default,
            int? limit = default,
            global::SoundCloud.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReturnsTheAuthenticatedUsersFeed3Arguments(
            ...
            var __authorizations = global::SoundCloud.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReturnsTheAuthenticatedUsersFeed3SecurityRequirements,
                operationName: "ReturnsTheAuthenticatedUsersFeed3Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReturnsTheAuthenticatedUsersFeed3Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::SoundCloud.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReturnsTheAuthenticatedUsersFeed3",
                                methodName: "ReturnsTheAuthenticatedUsersFeed3Async",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReturnsTheAuthenticatedUsersFeed3Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::SoundCloud.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReturnsTheAuthenticatedUsersFeed3ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
